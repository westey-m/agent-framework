...
|[Providing additional AI Context to an agent](./Agent_Step20_AdditionalAIContext/)|This sample demonstrates how to inject additional AI context into a ChatClientAgent using a custom AIContextProvider component that is attached to the agent.|
