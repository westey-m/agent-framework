...
/// <summary>Provides a collection of utility methods for working with JSON data in the context of vector data memory.</summary>
internal static partial class VectorDataMemoryJsonUtilities
{
    /// <summary>
