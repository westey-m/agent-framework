...
public sealed class FileMemoryProvider : AIContextProvider, IDisposable
{
    ...
    /// <summary>
    /// Replace whole lines in a memory file. Provide a list of edits, each with a 1-based line number and the new line content.
    /// </summary>
    /// <param name="fileName">The name of the file to modify.</param>
    ...
    [Description("Replace whole lines in a memory file. Provide a list of edits, each with a 1-based line_number and the new_line content. Fails on out-of-range or duplicate line numbers.")]
