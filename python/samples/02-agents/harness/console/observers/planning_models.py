...
class PlanningQuestion(BaseModel):
    ...
    choices: list[str] | None = Field(
        ...
        description=(
            ...
            "Invalid choices would be [\"Enter tickers directly\", \"Paste tickers\"], since these conflict with the already existing freeform option, and doesn't directly provide valid inputs for the next turn."
